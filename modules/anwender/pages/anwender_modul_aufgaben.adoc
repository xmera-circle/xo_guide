...
+
image:anwender/modul_aufgaben_abfrage.png[Abfrage speichern]
+
...
+
image:anwender/modul_aufgaben_3-punkte-menue.png[] 
+
[NOTE]
...
In dem Bereich Dateien werden die dem Auftrag angehängten Dateien dargestellt, können heruntergeladen werden image:anwender/button_herunterladen.png[], können gelöscht werden image:anwender/button_loeschen_symbol.png[] oder die Dateibeschreibung geändert image:anwender/button_bearbeiten.png[] werden. +
...
Über den Button image:anwender/button_bearbeiten.png[] gelangt man in den Bearbeitungsmodus des Auftrags. In diesem Bereich lassen sich entsprechend der Erstellung einer Aufgabe die Attribute der Aufgabe ändern. +
+
...
Beobachter einer Aufgabe werden im persönlichen Dashboard (Meine Seite) und per Mail über Änderungen im Auftrag informiert. Über den Button image:anwender/button_beobachten_aus.png[] kann sich der Nutzer auf die Beobachterliste setzen bzw. mit dem Klick auf den Button image:anwender/button_beobachten_ein.png[] die Beobachtung wieder einstellen.

&#9451; Aufgabe Kopieren:: 

Soll ein Auftrag gleich oder ähnlich noch einmal durchgeführt werden, so kann der Auftrag mit seiner Konfiguration durch betätigen des Buttons image:anwender/button_kopieren.png[] kopiert werden. Es erscheint die Erfassungsmaske in dem die Grundeinstellungen von der Quellaufgabe übernommen wurden. +
...
Die Aufgabe kann zum einen durch Klicken des Button image:anwender/button_atom.png[] als atom-xml exportiert werden, um die Aufgabe in andere Systeme zu importieren. Zum Anderen kann mit Klicken des Buttons image:anwender/button_pdf.png[] eine PDF erstellt werden, um die Informationen der Aufgabe außerhalb des Systems zu nutzen.
...
image::anwender/modul_aufgaben_konfigurieren.png[]
...
Änderungen müssen mit dem Button image:anwender/button_speichern.png[] übernommen werden.
...
image::anwender/modul_aufgaben_kategorien-uebersicht.png[]
...
Eine neue Kategorie kann durch Klicken des Button image:anwender/button_neue-kategorie.png[] erstellt werden. Eine bestehende Kategorie kann über den Button image:anwender/button_bearbeiten.png[] bearbeitet werden.

In beiden Varianten wird folgende Maske aufgeblendet.

image::anwender/modul_aufgaben_kategorien-bearbeiten.png[]

Der Name ist dabei ein Pflichtfeld, die Zuweisung optional. Durch den Button image:anwender/button_speichern.png[] wird die Kategorie übernommen.

Eine bestehende Kategorie wird über den Button image:anwender/button_loeschen_symbol.png[] in der Kategoriezeile gelöscht. Wenn die Kategorie bereits genutzt wird, erscheint folgende Maske: 

image::anwender/modul_aufgaben_kategorien-verwendet.png[]
...
Über den Button image:anwender/button_anwenden.png[] kann der gewählte Prozess gestartet werden. Über den Button image:anwender/button_abbrechen.png[] wird der Löschvorgang abgebrochen.
...
image::anwender/modul_aufgaben_stapel_uebersicht.png[]
...
Unterhalb dieser Paketinformationen werden die dem Paket zugeordneten Aufgaben &#10126; gelistet und durch klick auf einen Aufgabe kann dieser geöffnet werden. Über das 3-Punkte-Menü in der Aufgabenzeile können auch direkt die Aufgabeneigenschaften angepasst werden, der Auftrag bearbeitet image:anwender/button_bearbeiten_symbol.png[], gelöscht image:anwender/button_loeschen_symbol.png[], kopiert image:anwender/button_kopieren_symbol.png[], beobachtet image:anwender/button_beobachten.png[] oder eine Unteraufgabe hinzugefügt image:anwender/button_hinzufuegen.png[] werden.
...
image::anwender/modul_aufgaben_pakete_uebersicht.png[]
...
+
image:anwender/modul_aufgaben_paket-neu.png[]
+
...
+
Mit dem Button image:anwender/button_anlegen.png[] wird das Paket gespeichert.

Paket bearbeiten:: 

Über den Button image:anwender/button_bearbeiten.png[] in der Paketzeile kann das Paket bearbeitet werden. Es erscheint folgende Maske, die in Großteilen der Maske bei der Erstellung eines Pakets entspricht. +
+
image:anwender/modul_aufgaben_paket_bearbeiten.png[]
+
...
+
[NOTE]
*Notiz:* Im Stapel können auch abgeschlossenen Pakete angezeigt werden, in dem über den Filter (wird über das Symbol image:anwender/button_einblenden.png[] am linken Bildschirmrand eingeblendet) geschlossene Pakete hinzugefügt werden.
+
...
Über den Button image:anwender/button-loeschen.png[] wird das paket gelöscht und steht nicht weiter zur Verfügung. Das Löschen ist nur möglich, wenn keine Aufgabe mit dem Paket verbunden ist. Ist das der Fall, wird der Löschvorgang mit folgender Meldung abgebrochen. +
+
image:anwender/modul_aufgaben_paket_fehler-loeschen.png[] 

Vollständige Pakete schließen:: 

Mit dem Button image:anwender/modul_aufgaben_vollstaendige-pakete.png[] werden alle Pakete, bei denen alle zugeordneten Aufgaben abgeschlossen sind, auf den Status _abgeschlossen_ gesetzt.

== Aufgaben importieren

xmera Omnia bietet die Möglichkeit Aufgaben zu importieren. Der Import-Prozess kann in die Auftragsübersicht und dort über die Auswahl image:anwender/button_importieren.png[] im 3-Punkte-Menü gestartet werden. 
...
+
image:anwender/modul_aufgaben_import-datei.png[]
+
Über den Button _Durchsuchen..._ kann die Importdatei über den Dateiexplorer ausgewählt werden. Durch image:anwender/button_weiter_rot.png[] wird der nächste Schritt aufgerufen. +
+
Jetzt werden die csv-Optionen abgefragt. +
+
image:anwender/modul_aufgaben_import-csv-optionen.png[]
+
...
Durch image:anwender/button_weiter_rot.png[] wird der nächste Schritt aufgerufen. +
+
...
+
image:anwender/modul_aufgaben_import-attributzuordnung.png[]
+
...
+
Mit dem Button image:anwender/button_zurueck_rot.png[] gelangt man wieder zu den csv-Optionen. Mit image:anwender/button_start-import.png[] wird der Import gestartet.
...
+
image:anwender/modul_aufgaben_import_bericht.png[]
