...
Die Aufgabe kann zum einen durch Klicken des Button image:anwender/modul_aufgaben_button_atom.png[] als atom-xml exportiert werden, um die Aufgabe in andere Systeme zu importieren. Zum Anderen kann mit Klicken des Buttons image:anwender/modul_aufgaben_button_pdf.png[] eine PDF erstellt werden, um die Informationen der Aufgabe außerhalb des Systems zu nutzen.
...
Änderungen müssen mit dem Button image:anwender/modul_aufgaben_button_speichern.png[] übernommen werden.
...
Eine neue Kategorie kann durch Klicken des Button image:anwender/modul_aufgaben_symbol_neue-kategorie.png[] erstellt werden. Eine bestehende Kategorie kann über den Button image:anwender/modul_aufgaben_symbol-aendern.png[] bearbeitet werden.

In beiden Varianten wird folgende Maske aufgeblendet.

image::anwender/modul_aufgaben_kategorien-bearbeiten.png[]

Der Name ist dabei ein Pflichtfeld, die Zuweisung optional. Durch den Button image:anwender/modul_aufgaben_symbol-speichern.png[] wird die Kategorie übernommen.

Eine bestehende Kategorie wird über den Button image:anwender/modul_aufgaben_symbol-loeschen.png[] in der Kategoriezeile gelöscht. Wenn die Kategorie bereits genutzt wird, erscheint folgende Maske: 
...
Über den Button image:anwender/modul_aufgaben_symbol-anwenden.png[] kann der gewählte Prozess gestartet werden. Über den Button image:anwender/modul_aufgaben_symbol-abbrechen.png[] wird der Löschvorgang abgebrochen.
...
Unterhalb dieser Paketinformationen werden die dem Paket zugeordneten Aufgaben &#10126; gelistet und durch klick auf einen Aufgabe kann dieser geöffnet werden. Über das 3-Punkte-Menü in der Aufgabenzeile können auch direkt die Aufgabeneigenschaften angepasst werden, der Auftrag bearbeitet image:anwender/modul_aufgaben_symbol-aendern.png[], gelöscht image:anwender/modul_aufgaben_symbol-loeschen.png[], kopiert image:anwender/modul_aufgaben_symbol-kopieren.png[], beobachtet image:anwender/modul_aufgaben_symbol-beobachten.png[] oder eine Unteraufgabe hinzugefügt image:anwender/modul_aufgaben_symbol-hinzufuegen.png[]werden.
...
+
Mit dem Button image:anwender/modul_aufgaben_button_anlegen.png[] wird das Paket gespeichert.

Paket bearbeiten:: 

Über den Button image:anwender/modul_aufgaben_button_bearbeiten.png[] in der Paketzeile kann das Paket bearbeitet werden. Es erscheint folgende Maske, die in Großteilen der Maske bei der Erstellung eines Pakets entspricht. +
+
...
+
[NOTE]
*Notiz:* Im Stapel können auch abgeschlossenen Pakete angezeigt werden, in dem über den Filter (wird über das Symbol image:anwender/modul_aufgaben_symbol-einblenden.png[] am linken Bildschirmrand eingeblendet) geschlossene Pakete hinzugefügt werden.
+
...
Über den Button image:anwender/modul_aufgaben_button-loeschen.png[] wird das paket gelöscht und steht nicht weiter zur Verfügung. Das Löschen ist nur möglich, wenn keine Aufgabe mit dem Paket verbunden ist. Ist das der Fall, wird der Löschvorgang mit folgender Meldung abgebrochen. +
+
...
xmera Omnia bietet die Möglichkeit Aufgaben zu importieren. Der Import-Prozess kann in die Auftragsübersicht und dort über die Auswahl image:anwender/modul_aufgaben_button_importieren.png[] im 3-Punkte-Menü gestartet werden. 
...
+
Über den Button _Durchsuchen..._ kann die Importdatei über den Dateiexplorer ausgewählt werden. Durch image:anwender/modul_aufgaben_button_weiter.png[] wird der nächste Schritt aufgerufen. +
+
...
Durch image:anwender/modul_aufgaben_button_weiter.png[] wird der nächste Schritt aufgerufen. +
+
...
+
Mit dem Button image:anwender/modul_aufgaben_button_zurueck.png[] gelangt man wieder zu den csv-Optionen. Mit image:anwender/modul_aufgaben_button_start-import.png[] wird der Import gestartet.
