...
sein. Erreicht wird dieses durch die xref:admin-handbuch:aufgabentyp.adoc[frei konfigurierbaren Aufgabentypen] und die an den Typ angepasste Ausgestaltung der Aufgabenmaske. Hier besteht die Möglichkeit durch ein- bzw. ausblenden der Standardeinträge (bis auf die Pflichtfelder) oder das Hinzufügen von xref:admin-handbuch:eigene-felder.adoc[benutzerdefinierten Feldern] die Aufgabenmaske individuell zu gestalten.
