...
Durch Klicken auf den Pfleil image:anwender-handbuch/button_sidebar_ausblenden.png[] bzw. image:anwender-handbuch/button_sidebar_einblenden.png[] lässt sich die Sidebar aus- bzw. einblenden.
...
Über den Button image:anwender-handbuch/button_dashboard_bearbeiten.png[Dashboard bearbeiten] wird die Bearbeitungsmaske für die Dashboard-Daten mit dem Namen, der Beschreibung, den Zugriffsrechten und den Strukturelementen. Anpassungen werden mit dem Button image:anwender-handbuch/button_speichern.png[Speichern] übernommen.
...
Wird die Maus über eine Block geführt, erscheint ein Blockmenü image:anwender-handbuch/modul_dashboard_blockmenue.png[Blockmenü]. Über dieses Blockmenü lassen sich die Dashboard-Inhalte bearbeiten.
...
image:anwender-handbuch/modul_dashboard_seitenstruktur.png[Dashboard Seitenstruktur]
