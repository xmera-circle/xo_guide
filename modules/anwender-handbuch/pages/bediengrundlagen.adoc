...
image:anwender-handbuch/einfuehrung_login.png[]

Ist die Zwei-Faktor-Authentifizierung aktiviert, erscheint anschließend die Abfrage nach dem Code. 

image:anwender-handbuch/einfuehrung_otp.png[]

Anschließend wird die Hauptseite von xmera Omnia angezeigt. Diese beinhaltet das xref:dashboard.adoc[xmera Omnia Dashboard].
...
image:anwender-handbuch/einfuehrung_menues.png[]

Topmenü::

Das Topmenü, im linken Bereich des Seitenkopfs, führt zu den Hauptelementen von xmera Omnia: +
+
- *Hauptseite:* Zugang zu den xref:dashboard.adoc[Dashboards]
...
- *DMS:* Zugang zum xref:modul-dms.adoc[Dokumentenmanagementsystem (DMS)]
...
image:anwender-handbuch/einfuehrung_objektmenue.png[]
...
image:anwender-handbuch/einfuehrung_suche_schnellnavigation.png[]
...
+
image:anwender-handbuch/einfuehrung_suchergebnisse.png[]
+
...
image:anwender-handbuch/einfuehrung_seite_schmal.png[]
...
image:anwender-handbuch/einfuehrung_seite_breit.png[]
...
image:anwender-handbuch/einfuehrung_liste_allgemein.png[]
...
Über den Button image:anwender-handbuch/button_zuruecksetzen.png[Zurücksetzen] wird der Filter wieder auf die Standard-Liste zurückgesetzt.
...
Der Filterbereich einer Liste kann durch den Pfeil image:anwender-handbuch/button_ausklappen.png[] ausgeklappt und wieder image:anwender-handbuch/button_einklappen.png[] eingeklappt werden. In den Zeilen des Filterbereichs werden die aktuell gewählten Einstellungen angezeigt.

image:anwender-handbuch/einfuehrung_filter_definition.png[]
...
image:anwender-handbuch/einfuehrung_filter_regeln_datum.png[]

Die ausgewählten Regeln werden durch Klick auf den Button image:anwender-handbuch/button_anwenden_grau.png[Anwenden] angewendet.

Filter hinzufügen::

Im rechten oberen Bereich des Filterbereichs befindet sich das Auswahlfeld für _Filter hinzufügen_. +
+
image:anwender-handbuch/einfuehrung_filter_hinzufuegen.png[]
+
...
+
image:anwender-handbuch/einfuehrung_filter_auswahl.png[]
+
Wird nach einem Attribut mit festen Werten gefiltert, so kann der gewünschte Wert ausgewählt werden. Durch Klick auf image:anwender-handbuch/button_plus.png[] bzw. image:anwender-handbuch/button_minus.png[] kann die Mehrfachauswahl aktiviert werden. +
+
image:anwender-handbuch/einfuehrung_filter_mehrfachauswahl.png[]
+
...
+
Die neu erstellte Regel wird durch Klick auf den Button image:anwender-handbuch/button_anwenden_grau.png[Anwenden] angewendet.
...
+
image:anwender-handbuch/einfuehrung_option_kachel.png[]
+
...
+
image:anwender-handbuch/einfuehrung_option_liste.png[]
...
+
image:anwender-handbuch/einfuehrung_option_spalten.png[]
+
Durch markieren einer _Verfügbaren Spalte_ und Klicken auf den image:anwender-handbuch/button_pfeil_rechts.png[] werden die markierten Spalten in den Bereich _Ausgewählte Spalten_ verschoben. Werden Spalten in der Liste _Ausgewählte Spalten_ markiert, werden diese mit dem Klick auf den Button image:anwender-handbuch/button_pfeil_links.png[] in die Liste _Verfügbare Spalten_ verschoben. +
+
...
+
- image:anwender-handbuch/button_pfeil_doppel_oben.png[] ganz noch oben verschoben
- image:anwender-handbuch/button_pfeil_oben.png[] um eine Position nach oben verschoben
- image:anwender-handbuch/button_pfeil_unten.png[] um eine Position nach unten verschoben
- image:anwender-handbuch/button_pfeil_doppel_unten.png[] ganz nach unten verschoben

+
Mit Klick auf den Button image:anwender-handbuch/button_anwenden_grau.png[] werden die Änderungen übernommen.
...
+
image:anwender-handbuch/einfuehrung_option_gruppieren.png[]
+
Über das Auswahlfeld im Bereich _Gruppiere Ergebnisse nach_ werden die möglichen Gruppierungsattribute angezeigt. Mit Klick auf den Button image:anwender-handbuch/button_anwenden_grau.png[] werden die Änderungen übernommen. +
+
In der gruppierten Liste werden die Anzahl der Elemente pro Gruppe als rot hinterlegte Zahl dargestellt. Die Elemente der Gruppe können über Klicken auf den Pfeil image:anwender-handbuch/button_einklappen.png[] eingeklappt bzw. über den Pfeil image:anwender-handbuch/button_ausklappen.png[] ausgeklappt werden.

Summe:: 

Sind Zahlenwerte teil der Attribute, so kann man pro Gruppe auch den Summenwert darstellen. +
+
image:anwender-handbuch/einfuehrung_option_summe.png[]
+
...
+
image:anwender-handbuch/einfuehrung_option_anzeigen.png[]
+
In der Liste werden unterhalb der Spaltenwerte die ausgewählten Texte (im Beispiel oben der Text der Bemerkung) angezeigt.

Sortierungen::

In welcher Form die Liste sortiert wird, wird über das Symbol image:anwender-handbuch/einfuehrung_sortierung_up.png[] für _aufsteigend_ bzw. image:anwender-handbuch/einfuehrung_sortierung_down.png[] für _absteigend sortiert_ links neben der Spaltenüberschrift der Spalte, nach der sortiert wurde, dargestellt. +
+
...
+
image:anwender-handbuch/einfuehrung_abfrage_sidebar.png[]
+
...
+
Nachdem eine Liste erstellt wurde, erscheint der Button image:anwender-handbuch/button_speichern.png[]. Wird das Speichern geklickt, erscheint der Konfigurationsdialog. +
+
image:anwender-handbuch/einfuehrung_abfrage_maske.png[]
+
...
+
Mit Klick auf den Button image:anwender-handbuch/button_speichern.png[] wird die Abfrage gespeichert und es erscheint die gewünschte Liste.

Abfrage bearbeiten::

Um eine Abfrage bearbeiten zu können, ist diese zunächst aufzurufen. Anschließend kommt man durch den Klick auf den Button image:anwender-handbuch/button_bearbeiten.png[Bearbeiten] in die Eigenschaftsmaske der Abfrage, in der die Filter und Gestaltungsoptionen angepasst werden können. Mit dem Speichern werden die Anpassungen übernommen und die geänderte Abfrage aufgerufen.

Abfrage löschen::

Zum Löschen einer Anfrage ist die zu löschende Abfrage zu öffnen. Durch Klicken auf den Button image:anwender-handbuch/button_loeschen.png[] wird nach Bestätigung in einer Sicherheitsabfrage die Anfrage gelöscht.
