...
Eine weitere Wikiseite wird über das 3-Punkte-Menü und die Auswahl image:anwender-handbuch/button_neue_wiki_seite.png[] aufgerufen. Im Dialog _Neue Wiki-Seite_ müssen der Titel und die _Übergeordnete Seite_ festgelegt werden.
...
Die Sidebar kann individuell ergänzt werden. Über den Button image:anwender-handbuch/button_bearbeiten.png[bearbeiten] im oberen Bereich der Sidebar gelangt man in die Bearbeitungsseite der Sidebar.
...
Über Klick auf den Button image:anwender-handbuch/button_bearbeiten.png[Bearbeiten] gelangt man in den Bearbeitungsmodus für die aktuelle Wikiseite.
...
Die Umschaltung zwischen dem Bearbeitungsmodus und der Vorschau erfolgt über den Tab image:anwender-handbuch/modul_wiki_toolbar_bearbeiten_vorschau.png[Bearbeiten/Vorschau].
...
leicht in die Wikiseite einbinden. Bilder, die in der Zwischenablage gespeichert wurden, wie bspw. Screenshots, können direkt per _Str+V_ in das Textfeld kopiert werden.

== Seite beobachten

Um bei Änderungen auf der Wikiseite informiert zu werden, kann der Button image:anwender-handbuch/button_beobachten_aus.png[Beobachten] zugeschaltet werden. Er wechselt dann auf die Darstellung image:anwender-handbuch/button_beobachten_ein.png[Beobachten]. Durch einen weiteren Klick auf den Button wird der Beobachtungsmodus wieder ausgeschaltet.
...
In der Liste werden das Datum der Änderung, der Autor und der Kommentar gelistet. Über die Auswahlpunkte zu Beginn jeder Zeile können zwei Änderungsschritte ausgewählt werden, die über den Button image:anwender-handbuch/button_unterschiede_anzeigen.png[] verglichen werden können. 
...
image:anwender-handbuch/modul_wiki_macro_list.png[Liste aktueller Makros]
...
Bevor mit dem Zeichnen begonnen werden kann, wird eine Standarddatei mit Hilfe der Wiki-Toolbar erstellt. Hierzu muss image:anwender-handbuch/modul_wiki_toolbar_drawio_diagramm.png[] gelickt werden. Es erscheint folgendes Eingabefenster:

image:anwender-handbuch/modul_wiki_grafik_erstellen.png[]
...
image:anwender-handbuch/modul_wiki_drawio_startbutton.png[Drawio Startbutton]

Nach dem Doppelklick auf den Startbutton kann mit der Zeichnung begonnen werden.

image:anwender-handbuch/modul_wiki_drawio_editor.png[Drawio Editor]
