...
Die Übersicht der Objekte wird im xref:bediengrundlagen.adoc#_anwendungsmenüs[Topmenü] über den Menüpunkt _Objekte_ aufgerufen. Jeder Anwender sieht die öffentlichen Objekte und die Objekte, in denen er eine Rolle zugewiesen bekommen hat.
...
+
image:anwender-handbuch/verknuepfung_konfiguration_undefined.png[Verknüpfung mit Diensten (Ojekte)]
+
