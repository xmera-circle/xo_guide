...
Die Übersicht der Objekte wird im xref:aufbau.adoc#_anwendungsmenüs[Topmenü] über den Menüpunkt  __Objekte__ aufgerufen. Jeder Anwender sieht die öffentlichen Objekte und die Objekte, in denen er eine Rolle zugewiesen bekommen hat.
