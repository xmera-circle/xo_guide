...
Über den Button image:anwender-handbuch/button_neues_forum.png[] wird die Erfassungsmaske des Forum geöffnet.
...
Zum einen Besteht die Möglichkeit über den Button image:anwender-handbuch/button_zitieren.png[zitieren] eine Antwort mit Zitat der Themenbeschreibung zu erstellen oder unterhalb des Themas bzw. den Themenantworten die Erfassungsmaske für die Antworten zu öffnen. +
+
image:anwender-handbuch/modul_foren_antworten.png[]
+
Mit OK wird die Antwort übernommen. Über die Button image:anwender-handbuch/modul_foren_antworten_bearbeiten.png[] kann die Antwort zitiert, bearbeitet oder gelöscht werden.