...
Das Gantt-Diagramm wird beim öffnen nach offenen Aufgaben gefiltert.  Der Filter lässt sich über die xref:aufbau.adoc#_filter_und_optionen[Filteroptionen] vielfältig anpassen.
