...
Mit Klicken des Buttons image:anwenderhandbuch/button_hinzufuegen.png[] wird die Auswahl dem Objekt hinzugefügt und man gelangt wieder zur Datei-Übersichtsseite.
