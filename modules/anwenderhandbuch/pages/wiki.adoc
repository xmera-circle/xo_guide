...
Bevor mit dem Zeichnen begonnen werden kann, wird eine Standarddatei mit Hilfe der Wiki-Toolbar erstellt. Hierzu muss image:anwenderhandbuch/wikitoolbar/drawio_diagramm.png[] gelickt werden. Es erscheint folgendes Eingabefenster:
