...
[NOTE]
Objektklassen werden zusätzlich als Parameter in einigen Objektmodulen und globalen Systemeinstellungen benötigt. Beispiele hierfür sind das Modul __Aufgaben__, ____  und das Modul __Tabellen__.
