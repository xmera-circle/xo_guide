...
Die Attribute __ID__ und __Thema__ sind mit der Aufgabe verlinkt.
...
[NOTE]
Das vollständige Menü wird nur bei entsprechenden Berechtigungen angezeigt.
...
=== Status
&#10126;
Der Status gibt den Bearbeitungsstand der Aufgabe wieder. Zu jedem Aufgabetyp gibt es einen Startwert. Die Statusführung (Workflow) wird durch die Administration für jeden Aufgabentyp einzeln festgelegt.
...
Diese Zusammenfassung der Aufgabenpaket in einem Objekt wird als _Stapel_ dargestellt.
...
Aufgabenpakete werden in der Konfiguration eines Objekts konfiguriert. In der Objektkonfiguration gelangt man über den Reiter __Aufgabenpakete__ in der Liste der in diesem Objekt erstellten Aufgabenpakete.
