...
|E-Mail-Validierungscode
|Der Administrator legt fest wie die 2-Faktor-Authentifizierung mittels E-Mail-Validierungscode eingesetzt werden soll:

- gesperrt » Die 2-Faktor-Authentifizierung mittels E-Mail-Validierungscode steht dem Anwender nicht zur Verfügung.
- optional » Der Administrator kann den E-Mail-Validierungscode für einzelne Nutzer aktivieren.
- erforderlich, falls keine Authentifizierungs-App aktiv ist » Der E-Mail-Validierungscode dient als Ersatzlösung, falls kein 2. Faktor mittels App eingerichtet wurde.
