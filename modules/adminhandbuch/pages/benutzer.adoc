...
Die Rollenzuordnung zu jedem einzelnen Objekt kann in der Objektkonfiguration xref:anwenderhandbuch:objekte.adoc#_mitglieder_verwalten[im Tab Mitglieder] festgelegt werden. +
+
