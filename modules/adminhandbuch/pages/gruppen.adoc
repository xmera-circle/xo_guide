...
In dieser Maske muss nur der Gruppenname festgelegt werden. Durch einen Klick auf _Anlegen_ wird die Gruppe erstellt und der Benutzer wieder zur Standardansicht geleitet. Durch einen Klick auf _Anlegen und weiter_ wird nach dem Klicken wiedrum die Maske zum Erfassen einer neuen Gruppe geöffnet.
